// Static model metadata: context-length lookup + a rough token estimator.
// Distinct shape/purpose from catalog.js (which holds provider/id/tags catalog
// entries) -- this is a flat model-id -> contextLength table plus a helper
// used to estimate token counts from raw message content.
...
const TABLE = {
    ...
    'grok-2': 128_000, 'grok-3': 1_000_000, 'grok-4': 2_000_000, 'grok-4.6': 2_000_000, 'grok-4-fast': 2_000_000,
