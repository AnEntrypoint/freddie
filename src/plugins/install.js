...
// (moved to ./install-registry.js; re-exported here to preserve this file's
// public import path for existing callers)
// ---------------------------------------------------------------------------
export { getRegistryUrl, setRegistryUrl, fetchRegistryIndex, searchRegistry, validateRegistryUrl } from './install-registry.js'
