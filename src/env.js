...
const REGISTRY = {
    ...
    FREDDIE_SAMPLER_MAX_RETRY_MS: { purpose: 'wall-clock ceiling for retrying a sole-configured model_preference entry through a model_unhealthy/rate_limit/sampler_backoff chain exhaustion before surfacing a hard failure (default 900000 = 15min)', kind: 'number' },
