...
// for offline VIEWING. The SDK js/css load from raw.githack.com (cross-origin,
// always-fresh @main -- see server.js's SPA-fallback comment) and are not
// precached here, so first paint after an offline reload needs
