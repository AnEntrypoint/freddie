...
export const _tool = ({
    ...
    handler: async ({ name, arguments: args = {} }, ctx = {}) => {
        ...
        // Return the underlying tool's own result directly -- {result: raw}
        // was a pure nesting level over what the proxied tool already
        // returns, with no information of its own.
