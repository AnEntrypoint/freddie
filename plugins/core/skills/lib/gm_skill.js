...
function resolveSkillMd() {
    ...
    // The gm-skill npm package's actual skill directory is named "gm" (its
    // SKILL.md frontmatter `name: gm`), not "gm-skill" -- the package name and
    // the skill name it ships are different strings.
...
export function registerGmSkill(pi, log) {
