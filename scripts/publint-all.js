...
const CONCURRENCY_ENV = 'FREDDIE_PUBLINT_CONCURRENCY'
...
function publintConcurrency(total) {
  if (total === 0) return 0
...
async function runPublint(target) {
  try {
