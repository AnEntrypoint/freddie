...
const SURFACES = new Map([
  ...
  ['web', ['--import', 'tsx', 'apps/cli/src/bin.js', 'web', '--patch', 'examples/web-cordis/cordis.yml']],
  ['acp', ['--import', 'tsx', 'packages/examples/acp-demo/src/bin.js', '--config', 'examples/acp-agent/cordis-tools.cordis.yml']],
])
