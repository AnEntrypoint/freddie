/**
 * Package-owned invariant companion for `@freddie/freddie-web-search-deepseek`.
 * @module @freddie/freddie-web-search-deepseek/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-web-search-deepseek'
