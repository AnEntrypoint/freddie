/**
 * Package-owned invariant companion for `@freddie/freddie-typert-protocol`.
 * @module @freddie/freddie-typert-protocol/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-typert-protocol'
