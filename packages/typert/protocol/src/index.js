...
/**
 * Mark one public instance method as a direct Remote invocation, or (called
 * with a single string argument) create a decorator for a method exported
 * under a distinct name.
 * @param methodOrExportName - decorated method, or a Remote export name.
