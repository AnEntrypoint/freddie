/**
 * Package-owned invariant companion for `@freddie/freddie-tool-subagent`.
 * @module @freddie/freddie-tool-subagent/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-tool-subagent'
