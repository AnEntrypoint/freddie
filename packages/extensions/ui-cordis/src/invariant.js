/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-cordis`.
 * @module @freddie/freddie-client-ui-cordis/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-cordis'
