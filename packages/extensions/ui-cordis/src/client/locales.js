...
export const zh = {
  ...
  'panel.plugins.aria': 'Cordis 动态插件',
  'panel.approvals.aria': 'Cordis 审批',
  'panel.trigger': 'Cordis 动态插件',
  'panel.runningCount': '{count} 个动态插件运行中',
...
export const en = {
  ...
  'panel.plugins.aria': 'Cordis dynamic plugins',
  'panel.approvals.aria': 'Cordis approvals',
  'panel.trigger': 'Cordis dynamic plugins',
  'panel.runningCount': '{count} dynamic plugins running',
