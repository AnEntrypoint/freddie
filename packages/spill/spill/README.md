...
| Package | Role |
|---|---|
| `@freddie/freddie-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@freddie/freddie-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@freddie/freddie-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
