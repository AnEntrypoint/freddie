...
class PosixProcessInspector {
  ...
  foregroundPgid(_shellPid) { throw new Error('not implemented') }
  isStdinWaiting(_pgid) { throw new Error('not implemented') }
  processTree(_rootPid) { throw new Error('not implemented') }
  processSession(_sessionId) { throw new Error('not implemented') }
  isAlive(_identity) { throw new Error('not implemented') }
