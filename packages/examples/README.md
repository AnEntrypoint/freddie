...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@freddie/freddie-agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@freddie/freddie-acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@freddie/freddie-sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
