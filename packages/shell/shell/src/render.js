/**
 * Shared rendering helpers for the shell tools (`freddie-tool-bash`,
 * `freddie-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @freddie/freddie-shell/render
 */
