/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-settings`.
 * @module @freddie/freddie-client-ui-settings/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-settings'
