/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-directory-picker-browse`.
 * @module @freddie/freddie-client-ui-directory-picker-browse/invariant
 */
