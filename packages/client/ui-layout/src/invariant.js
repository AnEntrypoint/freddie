/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-layout`.
 * @module @freddie/freddie-client-ui-layout/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-layout'
