/**
 * Package-owned invariant companion for `@freddie/freddie-client-connection`.
 * @module @freddie/freddie-client-connection/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-connection'
