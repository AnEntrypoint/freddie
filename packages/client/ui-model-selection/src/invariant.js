/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-model-selection`.
 * @module @freddie/freddie-client-ui-model-selection/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-model-selection'
