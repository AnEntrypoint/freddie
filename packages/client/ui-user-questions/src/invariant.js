/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-user-questions`.
 * @module @freddie/freddie-client-ui-user-questions/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-user-questions'
