/**
 * Package-owned invariant companion for `@freddie/freddie-client-ui-theme`.
 * @module @freddie/freddie-client-ui-theme/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-client-ui-theme'
