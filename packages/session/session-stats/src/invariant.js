/**
 * Package-owned invariant companion for `@freddie/freddie-session-stats`.
 * @module @freddie/freddie-session-stats/invariant
 */
 ...
 * ids) are owned and runtime-checked by freddie-agent-loop and the session
 * surface, not here.
 */
const install = () => {}
