...
| [`tool-gm/`](tool-gm/README.md) | Model-facing `gm_*` tools over `ctx.gm` (instruction, phase-status, codesearch, recall, prd-add/resolve, mutable-add/resolve, transition, exec_js, git family, scan_deps, residual-scan) |
