/**
 * Package-owned invariant companion for `@freddie/freddie-jobs-local`.
 * @module @freddie/freddie-jobs-local/invariant
 */
...
/**
 * No runtime invariant: `@freddie/freddie-jobs/invariant` owns per-snapshot identity, status,
