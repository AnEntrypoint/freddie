 ...
 * (`@freddie/freddie-sandbox-local`) and the in-process filesystem fence
 * (`@freddie/freddie-fs-sandbox`) both derive their allow-list here, so "the
