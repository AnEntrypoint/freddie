 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in freddie-llm (tool-call
 * correlation), the shared agent/session `SessionId` in freddie-session, and
 * `JobId` in freddie-jobs. Branding is for ids that cross package boundaries and
 ...
 * package.
 *
 * This package was TypeScript-only at compile time: its sole export,
 * `Branded<B>`, has zero runtime representation and is dropped entirely in
