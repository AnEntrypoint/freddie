/**
 * Package-owned invariant companion for `@freddie/freddie-home-paths`.
 * @module @freddie/freddie-home-paths/invariant
 */

/* jscpd:ignore-start */
const PACKAGE_NAME = '@freddie/freddie-home-paths'
