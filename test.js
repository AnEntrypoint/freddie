...
await T('host+tools+toolsets', async () => {
    ...
    if (fs.existsSync('node_modules/gm-cc')) assert.ok(h.ccPlugins().some(p => p.manifest.name === 'gm') && h.pi.skills.list().some(s => s.name.startsWith('gm:')), 'gm-cc node_modules auto-discovery')
