...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [freddie-find-simplifications](../freddie-find-simplifications/SKILL.md)).
