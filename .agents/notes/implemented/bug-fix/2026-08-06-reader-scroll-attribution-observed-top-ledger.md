...
This decision's test suite (a `chat-view.client.spec.tsx` unit spec pinning the ledger contract directly, plus keyboard-paging and touch-style-fling scenarios in the browser e2e lane) is gone along with the rest of the automated test suite; see [drop-automated-test-suite-testing-notes](../testing/2026-09-02-drop-automated-test-suite-testing-notes.md).
