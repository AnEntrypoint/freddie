...
- **`docs/testing.md` rule** (no longer present in this checkout): "test the real entry path", line coverage is not behavior coverage — codifies the lesson for every future plugin.
