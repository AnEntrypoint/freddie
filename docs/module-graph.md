...
Inter-package dependencies among the `@freddie/freddie-*` harness packages, derived from each package's `peerDependencies` (the canonical runtime-dependency signal) and grouped by the `packages/<group>/<pkg>` hierarchy. An edge `a --> b` means package `a` depends on package `b`. Names have the `@freddie/freddie-` prefix stripped.
...
| `llm-mock-server` (test-support, not yet built) | `test-support` | [`invariants`](../packages/runtime-diagnostics/invariants) |
| `typert-generator` (package scaffold only, not yet built) | `typert` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| `acp-snapshot` (test-support, not yet built) | `test-support` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
...
| `loader-smoke` (test-support, not yet built) | `test-support` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
...
| `agent-loop-testkit` (test-support, not yet built) | `test-support` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| `llm-replay` (test-support, not yet built) | `test-support` | [`compaction`](../packages/compaction/compaction), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
...
| `client-test-runtime` (test-support, not yet built) | `test-support` | [`client-runtime`](../packages/client/runtime), [`client-ui-renderer`](../packages/client/ui-renderer), [`client-ui-slots`](../packages/client/ui-slots), [`host-apiproxy`](../packages/host/apiproxy), [`invariants`](../packages/runtime-diagnostics/invariants) |
